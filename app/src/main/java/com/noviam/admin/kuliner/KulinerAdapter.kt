...
class KulinerAdapter (
    ...
    val layoutResId: Int,
    val anggotaList: List<variabel_R_kuliner>
) : ArrayAdapter<variabel_R_kuliner>(anggotaContext, layoutResId, anggotaList){
    ...
    private fun updateDialog(anggota: variabel_R_kuliner){
        val builder = AlertDialog.Builder(anggotaContext)
        builder.setTitle("Update Data")
        val inflater = LayoutInflater.from(anggotaContext)
        val view = inflater.inflate(R.layout.activity_update_kuliner, null)
        ...
        builder.setPositiveButton("Ubah") {p0, p1 ->
            ...
            val anggota = variabel_R_kuliner(anggota.id, nama, alamat, deskripsi )
