...
class TambahKuliner  : AppCompatActivity(){
    ...
    private lateinit var detilList : MutableList<DetilKuliner>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_tambah_detil_kuliner)
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                if (snapshot.exists()) {
                    ...
                    for (a in snapshot.children){
                        val detil = a.getValue(DetilKuliner::class.java)
                        if (detil != null){
                            detilList.add(detil)
                        }
                    }

                    val adapter = DetilKulinerAdapter(this@TambahKuliner,
                        R.layout.activity_item_detil_kuliner, detilList)
