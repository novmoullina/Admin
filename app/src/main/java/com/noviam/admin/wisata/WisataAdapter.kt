...
class WisataAdapter (
        ...
        val layoutResId: Int,
        val anggotaList: List<variabel_R_wisata>
) : ArrayAdapter<variabel_R_wisata>(anggotaContext, layoutResId, anggotaList){
    ...
    private fun updateDialog(anggota: variabel_R_wisata){
        val builder = AlertDialog.Builder(anggotaContext)
        builder.setTitle("Update Data")
        val inflater = LayoutInflater.from(anggotaContext)
        val view = inflater.inflate(R.layout.activity_update_wisata, null)
        ...
        builder.setPositiveButton("Ubah") {p0, p1 ->
            ...
            val anggota = variabel_R_wisata(anggota.id, nama, alamat, deskripsi )
